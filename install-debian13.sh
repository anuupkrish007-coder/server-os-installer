...
echo "===================================================="
echo "  Debian 13 (Trixie) Installer (NVMe OS Only)"
...
read -rsp "Enter Root Password for Debian 13: " ROOT_PASS
echo ""
...
# --------------------------------------------------
# 4. Debootstrap Debian 13 (Trixie) Core
# --------------------------------------------------
echo "--> Debootstrapping Debian 13 (Trixie)..."
debootstrap --arch=amd64 trixie /mnt/target http://deb.debian.org/debian/
...
# Apt Sources List for Debian 13 Trixie
...
echo "===================================================="
echo " Debian 13 (Trixie) Installation Complete!"
